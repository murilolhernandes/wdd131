...
setNewImage(images, 0, "picture-container1", "image1");
// setNewImage(images, 1, "picture-container2", "image2");
// setNewImage(images, 2, "picture-container3", "image3");
// setNewImage(images, 3, "picture-container4", "image4");

function setNewImage(array, index, className1, className2) {
  let newPicture = document.createElement("picture");
  newPicture.classList.add(className1);
  heroContainer.appendChild(newPicture);

  let pictureContainer = document.querySelector("." + className1);
  ...
  newImage.classList.add("hero-image", "fade-in", className2);
  pictureContainer.appendChild(newImage);

  // if (newImage.loading === undefined) {
  //   newImage.loading = "eager";
  // } else {
  //   newImage.loading = array[index].loading;
  // }
